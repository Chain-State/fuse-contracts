...
async function loadCardano() {
    ...
    if (!nami) {
        ...
        const lucid = await L.Lucid.new(
            new L.Blockfrost("https://cardano-preprod.blockfrost.io/api/v0", "preprodhfhVpg93ER5xDj0WQjASmhO3PBlOndis"),
            "Preprod",
        );
...
async function submitCardanoTx(signedTx) {
    ...
    addLinkToTable("cardanoTxTable", "https://preprod.cardanoscan.io/transaction/" + tid, tid);
}
